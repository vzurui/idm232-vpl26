...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $name = htmlspecialchars($row['recipe_name'] ?? 'Recipe Name Unavailable'); // Fetch the recipe name
        $subtitle = htmlspecialchars($row['recipe_subtitle'] ?? 'Subtitle Unavailable'); // Fetch the recipe subtitle
        ...
        echo "<img src='$placeholderImage' alt='Image of $name'>"; // Placeholder image
